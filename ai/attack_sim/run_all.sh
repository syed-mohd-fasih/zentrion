...
python3traffic_spike.py        --url "$URL" --duration "$DURATION" --threads 20 &
python3suspicious_pattern.py   --url "$URL" --duration "$DURATION" --rps 2 &
python3new_endpoint.py         --url "$URL" --rounds 5 &
python3unauthorized_access.py  --url "$URL" --duration "$DURATION" &
python3high_error_rate.py      --url "$URL" --duration "$DURATION" --rps 5 &
python3latency_anomaly.py      --url "$URL" --duration "$DURATION" --concurrency 30 &
python3unusual_source.py       --url "$URL" --duration "$DURATION" --rps 2 &
...
echo "Then run: python3data/export_from_postgres.py"
